            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2"><strong>With Helen:</strong> Helen's approach to trauma therapy prioritizes safety, choice, and empowerment:
                <ul className="list-disc pl-6 ">
                  <li><strong><Link href={routes.styles.show('trauma-informed')} className="text-primary hover:underline hover:text-accent">Trauma-Informed Care</Link></strong> - Recognition of how trauma affects the brain and body, prioritizing safety and client choice</li>
                  <li><strong><Link href={routes.styles.psychodynamic()} className="text-primary hover:underline hover:text-accent">Psychodynamic Therapy</Link></strong> - Exploring how past experiences shape current patterns while building internal resources</li>
                  <li><strong><Link href={routes.styles.cbt()} className="text-primary hover:underline hover:text-accent">Cognitive Behavioral Techniques</Link></strong> - Addressing trauma-related beliefs and thought patterns</li>
                  ...
                  <li><strong><Link href={routes.styles.show('lifecoaching')} className="text-primary hover:underline hover:text-accent">Life Coaching</Link></strong> - Setting goals and developing practical strategies for moving forward after trauma</li>
                </ul>
              </li>
            </ul>
            <p className="mb-4">
