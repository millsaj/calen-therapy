...
export const metadata = buildMetadata({
  ...
  url: routes.focuses.healthWellbeing(),
});
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2"><strong>With Helen:</strong> Helen's approach includes:
                <ul className="list-disc pl-6 ">
                  <li><strong><Link href={routes.approaches.personCentered()} className="text-primary hover:underline hover:text-accent">Person-Centered therapy</Link></strong> to provide a supportive environment for exploring your health journey</li>
                  <li><strong><Link href={routes.approaches.cbt()} className="text-primary hover:underline hover:text-accent">Cognitive Behavioral techniques</Link></strong> to address thoughts and behaviors that impact health</li>
                  <li><strong><Link href={routes.approaches.psychodynamic()} className="text-primary hover:underline hover:text-accent">Psychodynamic approaches</Link></strong> to explore how past experiences may affect your relationship with health</li>
                  <li><strong><Link href={routes.approaches.show('lifecoaching')} className="text-primary hover:underline hover:text-accent">Life Coaching</Link></strong> to develop concrete health goals and practical strategies for lifestyle changes</li>
                </ul>
              </li>
              <li className="mb-2"><strong>With Carl:</strong> <Link href={routes.approaches.hypnotherapy()} className="text-primary hover:underline hover:text-accent">Solution Focused Hypnotherapy</Link> can be particularly beneficial for health and wellbeing by:
                <ul className="list-disc pl-6 ">
