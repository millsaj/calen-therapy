            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2"><strong>With Helen:</strong> Helen can draw from:
                <ul className="list-disc pl-6 ">
                  <li><strong><Link href={routes.styles.personCentered()} className="text-primary hover:underline hover:text-accent">Person-Centered therapy</Link></strong>, which creates a supportive environment to explore your authentic self and values</li>
                  <li><strong><Link href={routes.styles.psychodynamic()} className="text-primary hover:underline hover:text-accent">Psychodynamic approaches</Link></strong> to identify and work through patterns that may be holding you back</li>
                  <li><strong><Link href={routes.styles.cbt()} className="text-primary hover:underline hover:text-accent">Cognitive Behavioral techniques</Link></strong> to address self-critical thoughts and build confidence</li>
                  <li><strong><Link href={routes.styles.lifeCoaching()} className="text-primary hover:underline hover:text-accent">Life Coaching</Link></strong>, which focuses on setting and achieving personal development goals with accountability and practical action steps</li>
                </ul>
              </li>
              <li className="mb-2"><strong>With Carl:</strong> <Link href={routes.styles.hypnotherapy()} className="text-primary hover:underline hover:text-accent">Solution Focused Hypnotherapy</Link>, which can be particularly effective for confidence building:
                <ul className="list-disc pl-6 ">
