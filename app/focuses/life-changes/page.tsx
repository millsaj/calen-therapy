            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2"><strong>With Helen:</strong> Helen's approach draws from:
                <ul className="list-disc pl-6 ">
                  <li><strong><Link href={routes.styles.personCentered()} className="text-primary hover:underline hover:text-accent">Person-Centered Therapy</Link></strong> - Creating a supportive environment where you can explore your reactions to change and clarify your needs and values</li>
                  <li><strong><Link href={routes.styles.psychodynamic()} className="text-primary hover:underline hover:text-accent">Psychodynamic approaches</Link></strong> - Understanding how your past experiences influence your response to present transitions</li>
                  <li><strong>Systemic perspective</strong> - Examining how life changes affect your relationships and broader life systems</li>
                  <li><strong><Link href={routes.styles.show('lifecoaching')} className="text-primary hover:underline hover:text-accent">Life Coaching</Link></strong> - Setting concrete goals and developing actionable plans for your next chapter</li>
                </ul>
              </li>
              <li className="mb-2"><strong>With Carl:</strong> <Link href={routes.styles.hypnotherapy()} className="text-primary hover:underline hover:text-accent">Solution-Focused Hypnotherapy</Link> can help you:
                <ul className="list-disc pl-6 ">
