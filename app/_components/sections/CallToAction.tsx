    ...
    <div className="text-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center space-y-6 sm:space-y-0 sm:space-x-6">
        <a
          ...
          className="bg-white text-primary hover:bg-accent hover:text-white px-10 py-4 rounded-full font-bold text-lg transition-colors text-center"
        >
          {primaryButton.text}
        </a>
        <a
          href={secondaryButton.href}
          className="border-2 border-white text-white hover:bg-white hover:text-accent px-10 py-4 rounded-full font-bold text-lg transition-colors text-center"
        >
